...
$lang = array(
	...
	'message' => array(
		...
		'error' => array(
			...
			'password_restored' => array(
				...
				'body' => "Ο κωδικός πρόσβασης αλλάχτηκε με επιτυχία."
			),	
			...
			'generic' => array(
				'title' => "Γενικό σφάλμα",
				'body' => "Υπήρξε γενικό σφάλμα. Παρακαλώ αναφέρετε το στους διαχειριστές του συστήματος."
			)
		)
	),
	...
	'email' => array(
		...
		'node_contact' => array(
			'subject_prefix' => "WiND: ",
			'subject_suffix' => "",
			'body_prefix' => "Ο χρήστης ##username## σας έστειλε το παρακάτω μήνυμα\nμέσω της εφαρμογής WiND - Wireless Nodes Database:\n-------------------------------------------------------------------\n\n",
