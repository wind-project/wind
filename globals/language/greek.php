...
$lang = array(
	...
	'db' => array(
		...
		'ip_ranges__status-invalid' => '’κυρο',
		...
		'dns_zones__status-invalid' => '’κυρο',
		...
		'dns_nameservers__status-invalid' => '’κυρο',
	...
	'message' => array(
		'info' => array(
			...
			'request_dnszone_success' => array(
				...
				'body' => "Η αίτηση σας για DNS zone έγινε δεκτή. Σύντομα, η ομάδα hostmaster θα απαντήσει στην αίτησή σας, στο e-mail που έχετε δηλώσει. Μπορείτε να δείτε την κατάσταση του DNS zone στη σελίδα του κόμβου σας."
			),
		...
		'error' => array(
			...
			'schema_files_missing' => array(
				...
				'body' => 'Παρακαλώ, επικοινωνήστε με τον διαχειριστή για τη διόρθωση του σφάλματος.'
			),
			'generic' => array(
				'title' => "Γενικό σφάλμα",
				'body' => "Υπήρξε γενικό σφάλμα. Παρακαλώ αναφέρετε στους διαχειριστές του συστήματος."
			)
		)
	),
	...
	'help' => array(
		...
		'mynodes_dnszone_edit' => array(
			...
			'body' => 'Στη σελίδα αυτή, μπορείτε να ορίσετε τους υπεύθυνους DNS nameservers που θα διατηρούν τις πληροφορίες του zone.'
		),
		...
		'mynodes_dnsnameserver_edit' => array(
			...
			'body' => 'Στη σελίδα αυτή, μπορείτε να επεξεργαστείτε το όνομα του DNS nameserver που διατηρείτε. Αλλαγή της διεύθυνσης IP δεν είναι εφικτή. Θα πρέπει να κάνετε αίτηση διαγραφής του υπάρχοντος DNS nameserver και αίτηση καταχώρησης νέου.'
		),
		...
		'users_restore_password_recover' => array(
			...
			'body' => 'Στη σελίδα αυτή, μπορείτε να ανακτήσετε το χαμένο κωδικό πρόσβασης για το λογαριασμό σας. Εισάγετε τα ακόλουθα πεδία στη φόρμα και θα λάβετε e-mail με αναλυτικές οδηγίες.'
		),
		'users_restore_password_change' => array(
			'title' => 'Αλλαγή κωδικού πρόσβασης',
			'body' => 'Στη σελίδα αυτή, μπορείτε να αλλάξετε τον χαμένο κωδικό πρόσβασης του λογαριασμού σας. Δώστε ένα νέο κωδικό πρόσβασης στη φόρμα που ακολουθεί. ’μεσα, θα μπορείτε να πραγματοποιήσετε σύνδεση στο λογαριασμό σας, με το νέο κωδικό πρόσβασης.'
		),
		'users_add' => array(
			'title' => 'Εγγραφή νέου χρήστη',
			'body' => 'Δηλώστε τα στοιχεία σας στη φόρμα που ακολουθεί. Για την επιβεβαίωση του e-mail σας και την ενεργοποίηση του λογαριασμού σας, θα σας αποσταλεί  e-mail με αναλυτικές οδηγίες στη διεύθυνσή σας. Έως την ενεργοποίησή του, ο λογαριασμός σας θα παραμείνει ανενεργός χωρίς δυνατότητα σύνδεσης στο σύστημα.'
		),
		'users_edit' => array(
			'title' => 'Προφίλ χρήστη',
