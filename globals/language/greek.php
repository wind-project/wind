...
$lang = array(
	...
	'message' => array(
		'info' => array(
			...
			'message_sent' => array(
				'title' => "Το μήνυμα εστάλει",
				'body' => "Το μήνυμα εστάλει με επιτυχία."
			)
		),
		'error' => array(
			'login_failed' => array(
	...
	'email' => array(
		...
		'node_contact' => array(
			'subject_prefix' => "WiND: ",
			'subject_suffix' => "",
			'body_prefix' => "Ο χρήστης ##username## σας έστηλε το παρακάτω μήνυμα\nμέσω της εφαρμογής WiND - Wireless Nodes Database:\n-------------------------------------------------------------------\n\n",
	...
	'help' => array(
		...
		'users_restore_password_change' => array(
			...
			'body' => 'Στη σελίδα αυτή, μπορείτε να αλλάξετε τον χαμένο κωδικό πρόσβασης του λογαριασμού σας. Δώστε ένα νέο κωδικό πρόσβασης στη φόρμα που ακολουθεί. Άμεσα, θα μπορείτε να πραγματοποιήσετε σύνδεση στο λογαριασμό σας, με το νέο κωδικό πρόσβασης.'
		),
		'users_add' => array(
