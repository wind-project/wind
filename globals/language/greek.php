...
$lang = array(
	...
	'message' => array(
		...
		'error' => array(
			...
			'nodes_no_area_id' => array(
				...
				'body' => 'Δεν έχετε δηλώσει τον δήμο/κοινότητα που ανοίκει ο κόμβος. Για τον απόδοση IP C-Classes απαιτήται η δήλωση δήμου/κοινότητας. Ανατρέξτε στα στοιχεία του κόμβου σας.'
			),
	...
	'help' => array(
		'dnszones' => array(
			'title' => 'DNS zones',
			'body' => 'Στη σελίδα αυτή μπορείτε να αναζητήσετε DNS zones του δικτύου με βάση τα πεδία που προσφέρονται. Τα αποτελέσματα εμφανίζονται στον παρακάτω πίνακα. Επίσης, μπορείτε να διαλέξετε κάποιον κόμβο για προβολή των στοιχείων του.'
		),
		'mynodes_add' => array(
		...
		'mynodes_range' => array(
			...
			'body' => 'Περιγράψτε με σαφήνεια στο πεδίο Πληροφορίες το λόγο της αίτησής σας.'
		),
		'mynodes_dnszone_request_reverse' => array(
			'title' => 'Αίτηση απόδοσης DNS zone',
			'body' => 'Περιγράψτε με σαφήνεια στο πεδίο Πληροφορίες το λόγο της αίτησής σας.'
		),
		...
		'mynodes_dnszone_edit' => array(
			'title' => 'Επεξεργασία DNS zone',
			'body' => 'Στη σελίδα αυτή μπορείτε να ορίσετε τους υπέυθυνους DNS nameservers που θα διατηρούν τις πληροφορίες του zone.'
		),
		'mynodes_dnsnameserver_add' => array(
			'title' => 'Αίτηση απόδοσης DNS nameserver',
			'body' => 'Δώστε το όνομα και τη διεύθυνση του DNS nameserver.'
		),
		'mynodes_dnsnameserver_edit' => array(
			'title' => 'Επεξεργασία DNS nameserver',
			'body' => 'Στη σελίδα αυτή μπορείτε να επεξεργαστείτε όνομα του DNS nameserver που διατηρείτε. Αλλαγή διεύθυνσης IP δεν είναι εφικτή. Θα πρέπει να κάνετε αίτηση διαγραφής του υπάρχοντος DNS nameserver και αίτηση καταχώρησης νέου.'
		),
		'mynodes_link_add' => array(
			'title' => 'Προσθήκη διασύνδεσης',
			'body' => 'Στη σελίδα αυτή μπορείτε να προσθέσετε μια διασύνδεση του κόμβου σας με κάποιον άλλο. Συμπληρώστε με σαφήνεια όσο το δυνατόν περισσότερα από τα πεδία.'
		),
		'mynodes_link_edit' => array(
			'title' => 'Επεξεργασία διασύνδεσης',
			'body' => 'Στη σελίδα αυτή μπορείτε να επεξεργαστείτε μια διασύνδεση του κόμβου σας με κάποιον άλλο. Συμπληρώστε με σαφήνεια όσο το δυνατόν περισσότερα από τα πεδία.'
		),
		'mynodes_subnet_add' => array(
			'title' => 'Προσθήκη υποδικτύου',
			'body' => 'Στη σελίδα αυτή μπορείτε να προσθέσετε ένα υποδίκτυο του κόμβου σας. Για το τοπικό σας δίκτυο μπορείτε να δηλώσετε και διευθύνσεις που δεν περιέχονται σε IP C-Class που σας έχει αποδωθεί. Στην περίπτωση των διασυνδέσεων όμως, πρέπει να γίνει δήλωση μόνο από τον κόμβο που κατέχει το IP C-Class του υποδικτύου που γίνεται χρήση.'
		),
		...
		'mynodes_ipaddr_add' => array(
			...
			'body' => 'Στη σελίδα αυτή μπορείτε να προσθέσετε μία διεύθυνση IP του κόμβου σας. Το πεδίο Hostname πρέπει να καθορίζει πιο μηχάνημα φέρει τη συγκεκριμένη διεύθυνση IP και πρέπει να είναι κοινό σε όλες τις διευθύνσεις IP του συγκεκριμένου μηχανήματος.'
		),
		'mynodes_ipaddr_edit' => array(
			'title' => 'Επεξεργασία διασύνδεσης',
			'body' => 'Στη σελίδα αυτή μπορείτε να επεξεργαστείτε μία διεύθυνση IP του κόμβου σας. Το πεδίο Hostname πρέπει να καθορίζει πιο μηχάνημα φέρει τη συγκεκριμένη διεύθυνση IP και πρέπει να είναι κοινό σε όλες τις διευθύνσεις IP του συγκεκριμένου μηχανήματος.'
		),
		'nodes_search' => array(
		...
		'ranges_allocation' => array(
			...
			'body' => 'Στη σελίδα αυτή μπορείτε να δείτε το κομμάτι των διευθύνσεων που έχει δεσμευτεί για κάθε δήμο.'
		),
		'ranges_search' => array(
		...
		'users_restore_password_recover' => array(
			...
			'body' => 'Στη σελίδα αυτή μπορείτε να ανακτήσετε το χαμένο κωδικό πρόσβασης για το λογαριασμό σας. Δώστε τα ακόλουθα πεδία της φόρμας και θα λάβετε e-mail με αναλυτικές οδηγίες.'
		),
		'users_restore_password_change' => array(
			'title' => 'Αλλαγή κωδικού πρόσβασης',
			'body' => 'Στη σελίδα αυτή μπορείτε να αλλάξετε τον χαμένο κωδικό πρόσβασης του λογαριασμού σας. Δώστε έναν νέο κωδικό πρόσβασης στη φόρμα που ακολουθεί. ’μεσα θα μπορείτε να πραγματοποιήσετε σύνδεση στο λογαριασμό σας, με το νέο κωδικό πρόσβασης.'
		),
		'users_add' => array(
			'title' => 'Εγγραφή νέου χρήστη',
			'body' => 'Δηλώστε τα στοιχεία σας στην φόρμα που ακολουθεί. Για την επιβεβαίωση του e-mail σας και την ενεργοποίηση του λογαριασμού σας, θα αποσταλλεί μήνυμα e-mail με αναλυτικές οδηγίες στη διεύθυνσή σας. Έως την ενεργοποίησή του, ο λογαριασμός σας θα παραμένει ανενεργός χωρίς δυνατότητα σύνδεσης στο σύστημα.'
		),
		'users_edit' => array(
			'title' => 'Προφίλ χρήστη',
			'body' => 'Στη σελίδα αυτή μπορείτε να επεξεργαστείτε τα στοιχεία σας. Σε περίπτωση αλλαγής διεύθυνσης e-mail, θα αποσταλλεί μήνυμα e-mail με αναλυτικές οδηγίες ενεργοποίησης στη νέα διεύθυνση που θα δηλώσετε.'
		)
	)
